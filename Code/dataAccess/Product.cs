...
namespace DataAccess
{
	...
	public partial class Product : ActiveRecord<Product>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("products", TableType.Table, DataService.GetInstance("Provider"));
				...
				colvarCategoryId.DefaultSetting = @"";
					...
					colvarCategoryId.ForeignKeyTableName = "product_categories";
				...
				DataService.Providers["Provider"].AddSchema("products",schema);
			}
		}
		#endregion
		...
		public DataAccess.InventoryLogCollection InventoryLogRecords()
		{
			return new DataAccess.InventoryLogCollection().Where(InventoryLog.Columns.ProductId, Id).Load();
		}
		public DataAccess.OrderDetailCollection OrderDetails()
		{
			return new DataAccess.OrderDetailCollection().Where(OrderDetail.Columns.ProductId, Id).Load();
		}
		public DataAccess.ProductIngredientCollection ProductIngredients()
		{
			return new DataAccess.ProductIngredientCollection().Where(ProductIngredient.Columns.ProductId, Id).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a ProductCategory ActiveRecord object related to this Product
		/// 
		/// </summary>
		public DataAccess.ProductCategory ProductCategory
		{
			get { return DataAccess.ProductCategory.FetchByID(this.CategoryId); }
			set { SetColumnValue("category_id", value.Id); }
		}
		...
		/// </summary>
		public static void Insert(string varName,string varDescription,int varPrice,int? varCategoryId,DateTime? varCreatedAt,int? varUnit)
		{
		...
		/// </summary>
		public static void Update(int varId,string varName,string varDescription,int varPrice,int? varCategoryId,DateTime? varCreatedAt,int? varUnit)
		{
			Product item = new Product();
