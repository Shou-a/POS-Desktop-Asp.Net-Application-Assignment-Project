...
namespace DataAccess
{
    ...
    public partial class UserController
    {
	    ...
	    public void Insert(string Username,string Email,string Password,DateTime? CreatedAt)
	    {
		    User item = new User();
	    ...
	    public void Update(int Id,string Username,string Email,string Password,DateTime? CreatedAt)
	    {
		    User item = new User();
	        item.MarkOld();
	        item.IsLoaded = true;
