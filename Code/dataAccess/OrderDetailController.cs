...
{
    /// <summary>
    /// Controller class for order_details
    /// </summary>
    ...
    public partial class OrderDetailController
    {
	    ...
	    public void Insert(int OrderId,int ProductId,int EachCost,int Quantity,int? Discount)
	    {
	    ...
	    public void Update(int Id,int OrderId,int ProductId,int EachCost,int Quantity,int? Discount)
	    {
		    OrderDetail item = new OrderDetail();
	        item.MarkOld();
	        item.IsLoaded = true;
